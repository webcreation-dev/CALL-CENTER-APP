...
let MessagesRepository = MessagesRepository_1 = class MessagesRepository extends common_2.AbstractRepository {
    constructor(itemsRepository, entityManager) {
        super(itemsRepository, entityManager);
        this.logger = new common_1.Logger(MessagesRepository_1.name);
    }
};
MessagesRepository = MessagesRepository_1 = __decorate([

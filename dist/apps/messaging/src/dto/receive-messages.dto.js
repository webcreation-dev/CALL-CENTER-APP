...
class ReceiveMessagesDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { phone_number: { required: true, type: () => String }, canal: { required: true, enum: require("../enums/canal_type.enum").CanalTypeEnum }, message: { required: true, type: () => String }, user_id: { required: true, type: () => Number } };
    }
}
__decorate([

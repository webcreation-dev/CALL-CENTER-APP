...
let PropertiesRepository = PropertiesRepository_1 = class PropertiesRepository extends common_2.AbstractRepository {
    constructor(itemsRepository, entityManager) {
        super(itemsRepository, entityManager);
        this.logger = new common_1.Logger(PropertiesRepository_1.name);
    }
};
PropertiesRepository = PropertiesRepository_1 = __decorate([
